...
#---------------------------------------------------------------------------------------------#
## sdir = scripts directory '/home/bearer/Desktop/Taylor/ELS_PTSD/190905/Segment_ROI/Scripts'
## This is the directory containing all the code this program feeds.
#---------------------------------------------------------------------------------------------#
## dir = Segment_ROI main directory '/home/bearer/Desktop/Taylor/ELS_PTSD/190905/Segment_ROI'
